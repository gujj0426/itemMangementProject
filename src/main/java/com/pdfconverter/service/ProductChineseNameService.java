...
import com.pdfconverter.service.mapper.ProductNameMapperService;
...
public class ProductChineseNameService {
    ...
    @Resource
    private ProductNameMapperService productNameMapperService;
    ...
    public String getChineseName(String mainProductType, String model, String color, String productVariable) {
        ...
        String chineseName = productNameMapperService.getChineseName(
    ...
    public List<String> getAllChineseNames(String mainProductType) {
        return productNameMapperService.getAllChineseNames(mainProductType);
    }
    ...
    public void reloadConfig() {
        ...
        productNameMapperService.reloadMapping();
    }
    ...
    public String getConfigStats() {
        return String.format("商品中文名称映射规则: %d 条",
            productNameMapperService.getAllMappings().size());
    }
    ...
    public List<?> getAllRules() {
        return productNameMapperService.getAllMappings();
    }
}
